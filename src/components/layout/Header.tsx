          ...
          <div className="bg-white/90 backdrop-blur-md flex items-center justify-between gap-x-4 rounded-2xl py-2.5 pl-5 pr-2.5 shadow-[0_2px_10px_0px_rgba(139,92,246,0.2)] border border-purple-100/50 lg:rounded-[1.375rem] lg:grid lg:grid-cols-[1fr_auto_1fr] lg:justify-stretch lg:gap-x-12">
            ...
            <nav className="hidden lg:block">
              <ul className="flex items-center">
                ...
                {/* ✅ NEW: Admin Showcase Button - Only for FID 1346047 */}
                {farcasterData?.fid === 1346047 && (
                  <li>
                    <Link
                      className="flex items-center gap-x-1.5 px-3 py-2 text-sm font-medium bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg transition hover:opacity-90 shadow-md"
                      href="/showcase"
                      prefetch={true}
                    >
                      <svg
            ...
            <div className="px-4 py-4">
              ...
              <nav className="mb-4">
                <ul className="space-y-1">
                  ...
                  {/* ✅ NEW: Mobile Admin Showcase Button */}
                  {farcasterData?.fid === 1346047 && (
                    <li>
                      <Link
                        href="/showcase"
                        className="flex items-center justify-between px-4 py-3 text-base font-medium bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl transition hover:opacity-90 shadow-md"
                        onClick={() => setIsMobileMenuOpen(false)}
                        prefetch={true}
                      >
                        <div className="flex items-center gap-2.5">
